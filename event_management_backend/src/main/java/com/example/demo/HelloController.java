package com.example.eventmanagementbackend;
...
public class HelloController {
    ...
    public String hello() {
        return "Hello, Spring Boot! Welcome to eventmanagementbackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: eventmanagementbackend";
    }
}